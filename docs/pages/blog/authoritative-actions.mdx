...
preview: "Using OpenZeppelin's AccessControl for role-based authoritative servers prevents bot abuse in Web3 games while maintaining decentralization, working best on zero-gas-fee blockchains like SKALE with instant finality."
---

# Authoritative Actions

**TL;DR**
Authoritative servers can enhance Web3 applications by preventing bot abuse and managing game state while maintaining decentralization benefits. Using OpenZeppelin's AccessControl for role-based permissions, developers can create secure authority layers that automatically grant temporary access rights to execute on-chain actions. This approach works best on blockchains with zero gas fees and instant finality like SKALE, where variable transaction costs and slow confirmation times don't undermine the user experience or operational viability.
...
Are you building a Web3 game and are unsure how to design authoritative actions? Head over to [https://dirtroad.dev](https://dirtroad.dev/) to inquire.