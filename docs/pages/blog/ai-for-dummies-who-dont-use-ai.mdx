...
preview: "Three practical AI use cases for developers who don't use AI-first workflows: generating CURL requests via terminal AI, implementing obscure native APIs, and creating inline documentation for smart contracts."
---

# AI for Dummies (who don't use AI)

**TL;DR**
AI tools can enhance developer productivity without requiring full adoption of AI-first development workflows. This guide explores three practical use cases for engineers who don't rely heavily on AI coding assistants: generating CURL requests via terminal AI, using AI for obscure native language API implementation, and creating inline documentation for smart contracts. These targeted applications demonstrate how selective AI integration can streamline tedious tasks while maintaining traditional development approaches.
