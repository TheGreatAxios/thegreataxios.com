...
title: "Programmable Privacy (Part 5/5): Rebuilding Poker Onchain"
description: "Poker failed onchain because cards were visible. With dual encryption, CTX callbacks, and 6 AI agents, we rebuilt it — live at confidential-poker.vercel.app."
---

# Programmable Privacy (Part 5/5): Rebuilding Poker Onchain
...
Hole cards are dealt once, encrypted both ways. Players see their cards immediately via ECIES decryption. The contract holds TE-encrypted versions for showdown. Community cards deal via CTX callbacks — encrypted until programmable privacy reveals them.
...
- **Stack:** Vite, React 19, Hono, Foundry, SKALE
